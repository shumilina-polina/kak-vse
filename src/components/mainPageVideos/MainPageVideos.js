  ...
  return (
    <div className={s.videos_main_wrapper}>
      ...
      <div className={s.video_0}>
        <CardVideo
          Category={!loaded ? videos[0]?.attributes.category : 'success'}
      ...
      <div className={s.video_1}>
        <CardVideo
          Category={!loaded ? videos[1]?.attributes.category : 'success'}
      ...
      <div className={s.video_2}>
        <CardVideo
          Category={!loaded ? videos[2]?.attributes.category : 'success'}
